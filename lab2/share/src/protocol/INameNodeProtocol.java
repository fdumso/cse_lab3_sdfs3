...
public interface INameNodeProtocol {
     ...
     */
    SDFSFileChannel openReadwrite(String fileUri) throws FileNotFoundException, IllegalStateException;
     ...
     */
    SDFSFileChannel create(String fileUri) throws FileAlreadyExistsException;
    ...
    /**
     * Close a readwrite file. If file metadata has been isChanged, store them on the disk.
     *
     * @param fileUuid    file to be closed
     ...
     * @throws IllegalStateException    if uuid is illegal
     */
    void closeReadwriteFile(UUID fileUuid, int newFileSize) throws IllegalStateException, IllegalArgumentException;
     ...
     */
    void mkdir(String fileUri) throws FileAlreadyExistsException;

    /**
     * NameNodeRequest a new free block for a file
    ...
    /**
     * NameNodeRequest a special amount of free blocks for a file
     * No metadata should be written to disk until it is correctly close
     *
     * @param fileUuid    the file uuid with readwrite state
